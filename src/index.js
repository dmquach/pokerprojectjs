...
const cardObjectDefinitions = [
    {id:1, imagePath:'/images/K_of_hearts.png'},
    {id:2, imagePath:'/images/J_of_clubs.png'},
    {id:3, imagePath:'/images/Q_of_diamonds.png'},
    {id:4, imagePath:'/images/A_of_spades.png'}
]
const aceId = 4

const cardBackImgPath = '/images/2_of_clubs.png'
